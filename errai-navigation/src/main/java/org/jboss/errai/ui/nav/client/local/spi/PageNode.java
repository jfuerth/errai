...
public interface PageNode<W extends Widget> {
   ...
   *          the widget instance that was just returned from a call to
   *          {@link #content()}. Never null.
   * @return the current state of the page, which will be used in the history
   *         token on the URL. Must not be null.
   */
  public Multimap<String,String> pageHiding(W widget);
